...
public static class AutoAiRecoveryPatchValidator
{
    private static readonly HashSet<string> AllowedFields = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        nameof(SourceRecoveryConfigurationPatchDto.ContextMenuSelector),
        nameof(SourceRecoveryConfigurationPatchDto.LoginSuccessSelector),
        nameof(SourceRecoveryConfigurationPatchDto.SuccessUrlPattern),
